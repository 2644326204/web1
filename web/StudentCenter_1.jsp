<%-- 
    ...
    Author     : kun
<%@page import="mode.SchoolMessage"%>
...
-->
   ...
   <center><button class="button" onclick="click1()">
	注册</button></center>
       <center><button class="button" onclick="clickupdate()">
	修改个人信息</button>
    ...
    <script>
         ...
         function click2(){
             ...
             function clickupdate(){
                 window.location.href="updateServlet1";
             }
             function clickxu5(){
             ...
             function click3(){
              ...
              function clicklogin(){
                 ...
                 var dom1=document.getElementById("xu0");
                 var dom=document.getElementById("xu00");
