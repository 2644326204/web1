...
<div class="u2">
    ...
    <div class="u21">
        ...
        <div class="Box"  id="box">
            <a target="_blank" id="a5" onmouseover="mouseover5()" onmouseleave="mouseleave5()" onclick="click33()">
                &nbsp&nbsp发布研究成果
            </a>
...
<button class="button border-white">
    ...
    <div class="u22" id="u22">
          ...
          <form method="post" action="<%=request.getContextPath()%>/jijinServlet">
                    
                    <div class="title" style="margin-top: 100px;">
                        <em>&nbsp&nbsp基金号</em><input type="tel" name="num" placeholder="基金号" size="53">
                    </div>
                    <div class="someaspect" style="margin-top: 10px;">
                        <em>&nbsp&nbsp基金名</em><input type="text" name="name" placeholder="基金名" size="53">
                    </div>
                   <div class="someaspect" style="margin-top: 10px;">
                        <em>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp作者</em><input type="text" name="owner" placeholder="作者" size="53">
                    </div>
                    <div class="keywords" style="margin-top: 10px;">
                        <em>基金描述</em><textarea rows="5" cols="53" name="text"></textarea>
                    </div>
