<%-- 
    Document   : StudentCenter_2
    Created on : 2022-5-17, 11:22:06
...
//               items[j].style.display='none';
    ...
    <body>
        ...
        <div class="y0" id="y0">
             <center>
                 <div id="y00" class="y00">
                     </div>
                     
           
                         
                          <p><input type="submit" onclick="clickx()" id="login">
      ...
      <div class="xu0" id="xu0">
             <center>
                ...
                <p>&nbsp&nbsp&nbsp密码：<input type="password" id="password" name="password" size="30"/></p>
...
<div class="u1">
    <div class="websit">
        ...
        <p>教授：</p>
    <button class="button" onclick="clickwang()">
	汪卫华</button>
        <p>副教授：</p>
<button class="button border-main" onclick="clickchu()">
	储德林</button>
<button class="button border-sub" onclick="clickyang()">
	杨锦宏</button>
    <p>教师简介：</p>
    
<button class="button border-main" onclick="clicklu()">
	芦苇</button>
<button class="button border-main" onclick="clickren()">
	任珍珍</button>

    </div>
 <p>学生简介：</p>
    
<button class="button border-main" onclick="click()">
	刘胜</button>
...
<div class="u2">
    ...
    <div class="u21">
        ...
        <div class="Box"  id="box">
            <a target="_blank" id="a1" onmouseover="mouseover1()" onmouseleave="mouseleave1()" onclick="click2()">
        ...
        <div class="Box"  id="box">
            <a target="_blank" id="a22" onmouseover="mouseover22()" onmouseleave="mouseleave22()" onclick="clickxu4()">
        ...
        <div class="Box"  id="box">
            <a target="_blank" id="a2" onmouseover="mouseover2()" onmouseleave="mouseleave2()" onclick="clickguangxue()">
...
-->
   ...
   <center><button class="button" onclick="click1()">
	...
	修改个人信息</button>
       <input type="text" id="time1" disabled="disabled" style="text-align:center"></center>
...
<!--<div class="u5">
    ...
    <script>
         function click1(){
              ...
              function clickanhuidaxue(){
                 window.location.href="https://www.ahu.edu.cn/";
             }
         function click2(){
             ...
             function clickxu4(){
                 window.location.href="computerServlet1?group1=dfhghg";
             }
             function clickcailiao(){
                 window.location.href="cailiaoServlet1?group1=dfhghg";
             }
             function clickguangxue(){
                 window.location.href="sunServlet1?group1=dfhghg";
             }
             function clickxu5(){
