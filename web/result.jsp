...
<div class="u2">
    ...
    <div class="u21">
        ...
        <div class="Box"  id="box">
            <a target="_blank" id="a5" onmouseover="mouseover5()" onmouseleave="mouseleave5()" onclick="clickck3()">
                &nbsp&nbsp发布研究成果
            </a>
            
        </div>
        <div class="Box"  id="box">
            <a target="_blank" id="a22" onmouseover="mouseover22()" onmouseleave="mouseleave22()" onclick="click44()">
                &nbsp&nbsp&nbsp&nbsp&nbsp发布信息
            </a>
            
        </div>
        <div class="Box"  id="box">
            <a target="_blank" id="a22" onmouseover="mouseover22()" onmouseleave="mouseleave22()" onclick="click55()">
                &nbsp&nbsp&nbsp&nbsp&nbsp返回主界面
            </a>
...
<button class="button border-white">
    ...
    <div class="u22" id="u22">
          ...
          <form method="post" action="<%=request.getContextPath()%>/resultServlet1">
                    
                    <div class="title" style="margin-top: 100px;">
                        <em>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp作者</em><input type="tel" name="owner" placeholder="作者" size="53">
                    </div>
                    <div class="someaspect" style="margin-top: 10px;">
                        <em>&nbsp&nbsp文章名字</em><input type="text" name="name" placeholder="文章名字" size="53">
                    </div>
                   <div class="someaspect" style="margin-top: 10px;">
                        <em>&nbsp&nbsp发表期刊</em><input type="text" name="magazine" placeholder="发表期刊" size="53">
                    </div>
                    <div class="someaspect" style="margin-top: 10px;">
                        <em>&nbsp&nbsp&nbsp&nbsp&nbsp所属组</em><input type="text" name="group" placeholder="所属组" size="53">
                    </div>
                    
                   
                    
                    <input type="submit" value="上传" style="color:blue"/>
                </form>
    </center>
    ...
    <p>联系电话：8498348987<p>
     ...
     <script>
         ...
         function click2(){
             ...
             function click55(){
                 window.location.href="StudentCenter_1.jsp";
             }
        function clickx1(){
