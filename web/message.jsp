...
<button class="button border-white">
    ...
    <div class="u22" id="u22">
           ...
           <form method="post" action="<%=request.getContextPath()%>/MessageServlet1">
                    
                    <div class="title" style="margin-top: 50px;">
                        <em>信息标题</em><input type="tel" name="title" placeholder="信息标题" size="53">
                    </div>
                    <div class="someaspect">
                        <em>信息类型</em><input type="text" name="type" placeholder="信息类型" size="53">
                    </div>
                    <div class="keywords">
                        <em>关键信息</em><textarea rows="5" cols="53" name="keywords"></textarea>
                    </div>
                    <div class="text">
                        <em>信息内容</em> <textarea rows="10" cols="53" name="text"></textarea>
                    </div>
