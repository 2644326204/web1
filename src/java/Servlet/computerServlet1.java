 ...
 */
@WebServlet(name = "computerServlet1", urlPatterns = {"/computerServlet1"})
public class computerServlet1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //String group=decodeURIComponent(request.getParameter("group1")."utf-8");
            //String group=java.net.URLDecoder.decode(request.getParameter("group1"),"UTF-8");
